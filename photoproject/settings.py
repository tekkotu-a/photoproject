...
# お使いのものを入力してください
DEFAULT_FROM_EMAIL = 'zhepingxiaochi1@gmail.com'  # メールの送信元のアドレスを入力
EMAIL_HOST = 'smtp.gmail.com'            # GmailのSMPTサーバー　　　
EMAIL_PORT = 587                         # SMPTサーバーのポート番号
EMAIL_HOST_USER = 'zhepingxiaochi1@gmail.com'     # Gmailのアドレスを入力
EMAIL_HOST_PASSWORD = 'giyvxpczlpmpjsbc' # Gmailのアプリ用パスワードを入力
